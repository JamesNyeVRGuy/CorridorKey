...
{#if ready}
  <div class="landing">
    ...
    <section class="hero">
      ...
      <h1 class="hero-title">
        AI Green Screen Keying<br /><span class="hero-accent"
          >No GPU Required</span
        >
      </h1>
      <p class="hero-sub">
        Upload green screen footage. Get production-ready alpha mattes, clean
        foreground plates, and compositing-ready EXRs — processed on a
        community-powered GPU farm.
      </p>
      <div class="hero-actions">
        <a href="/signup" class="btn-primary">Start Keying</a>
        <a
          href="https://github.com/JamesNyeVRGuy/CorridorKey"
          class="btn-outline"
          target="_blank"
    ...
    <section class="section">
      ...
      <div class="steps">
        <div class="step">
          ...
          <p class="step-desc">
            Drag in your green screen video, image sequence, or single frame.
            Any resolution, any length.
          </p>
        </div>
        ...
        <div class="step">
          ...
          <p class="step-desc">
            CorridorKey's neural network generates alpha mattes and clean
            foreground plates. Sharded across multiple GPUs for speed.
          </p>
        </div>
        <div class="step-arrow">→</div>
        <div class="step">
          ...
          <p class="step-desc">
            Get your keyed EXRs — premultiplied RGBA ready to drop into Nuke,
            After Effects, DaVinci, or Blender.
          </p>
        </div>
      </div>
    </section>
    ...
    <section class="section farm-section">
      <div class="farm-content">
        ...
        <h3 class="farm-title">
          Contribute a GPU.<br />Earn processing credits.
        </h3>
        <p class="farm-desc">
          CorridorKey Cloud runs on a distributed render farm powered by the
          community. Connect your idle GPU as a node — it processes jobs for
          other users, and you earn credits to process your own footage. One
          Docker command to set up.
        </p>
    ...
    {#if !loggedIn}
      ...
      <footer class="landing-footer">
        <div class="footer-links">
          ...
          >
          <a href="https://discord.gg/nzz5ecPwCM" target="_blank" rel="noopener"
            >Discord</a
          >
          <a
